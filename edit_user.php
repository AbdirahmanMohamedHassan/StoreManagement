...
$sql = "SELECT id, user_name, password, full_name, department, phone, address FROM user  WHERE id  ='$_GET[id]'";
...
?>
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="number" name="id" value="<?php echo$row["id"] ?>"  class="form-control input-height" required/> </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="user_name" value="<?php echo$row["user_name"] ?>" class="form-control input-height" required/> </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="password" value="<?php echo$row["password"] ?>" class="form-control input-height" /> </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                <input type="text" name="full_name" value="<?php echo$row["full_name"] ?>" class="form-control input-height" /> </div>
                                             </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                  <input type="number" name="phone" value="<?php echo$row["phone"] ?>" class="form-control input-height" /> </div>
											</div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                  <input type="text" name="address" value="<?php echo$row["address"] ?>" class="form-control input-height" /> </div>
                                                </div>
                                                </div>
