...
$sql = "SELECT order_id, number, creation_date, description, purchase_order_id FROM orderr  WHERE order_id  ='$_GET[order_id]'";
...
?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="number" value="<?php echo$row["number"] ?>" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">     
                                                <input type="date" name="creation_date" value="<?php echo$row["creation_date"] ?>" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
