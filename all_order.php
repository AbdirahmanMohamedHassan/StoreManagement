                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">All Orders List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">All Orders List</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            <div class="btn-group">
					                                                <a href="add_order.php" id="addRow" class="btn btn-info">
						...
						$sql = "SELECT order_id, number, creation_date, description, purchase_order_id FROM orderr";
						...
						?>
																...
																<td class="left"><?php echo$row["number"] ?></td>
																<td class="left"><?php echo$row["purchase_order_id"] ?></td>
																<td class="left"><?php echo$row["creation_date"] ?></td>	
