...
<div class="info">
<h5  style="text-align: center"> PURCHASE ORDER REPORT</h5>  
</div>
<div class="lines">
...
$sql = mysqli_query($conn,"SELECT * FROM  purchase_order WHERE purchase_order_id='$id' or created_date BETWEEN '$startDate' AND '$endDate'");
