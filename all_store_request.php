                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">All Store Requests List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.php">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="#">Store Requests</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">All Store Requests List</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <div class="row">
					                        <div class="col-md-12">
					                            <div class="card card-box">
					                                <div class="card-head">
					                                    <header>All Store Requests List</header>
					                                    <div class="tools">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            <div class="btn-group">
					                                                <a href="add_store_request.php" id="addRow" class="btn btn-info">
							...
							while($row = $result->fetch_assoc()) {
								?>
																...
																<td class="left"><?php echo$row["id"] ?></td>
																	...
																	<td class="left"><?php echo$row["created_date"] ?></td>
